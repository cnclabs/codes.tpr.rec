...
int main(int argc, char **argv){
    ...
    double user_reg = arg_parser.get_double("-user_reg", 0.025, "user l2 regularization");
    double item_reg = arg_parser.get_double("-item_reg", 0.0025, "item l2 regularization");
    ...
    for (int w=0; w<worker; w++)
    {
        ...
        while (update < worker_update_times)
        {
            ...
            //user = sampler.draw_a_vertex_uniformly();
